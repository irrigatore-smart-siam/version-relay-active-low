...
#define TRIGPIN 3              //trigger del sensore a ultrasuoni
#define ECHOPIN 5              //echo del sensore a ultrasuoni
...
#define PIEZO = 1; //piezo elettrico sonoro che abbiamo usato a lezione per indicare se c'è acqua o meno nel serbatoio (in mancanza o in aggiunta ad alexa)
...
void setup() {
  ...
  timer.setInterval(checkMoisture);    // primo controllo umidità terreno  alla partenza
  timer.setInterval(checkWaterLevel);  // primo controllo livello dell'acqua alla partenza
}
